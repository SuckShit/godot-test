...
# 掉落权重，数值越大越容易在随机掉落时被抽中；设为0表示不参与掉落
...
# 道具效果持续时间，单位为秒
@export_range(0.0, 120, 0.1, "or_greater") var duration: float = 5.0
# 玩家移速倍率，基础1.0
@export_range(0.0, 5.0, 0.05, "or_greater") var move_speed_multiplier: float = 1.0
# 玩家射速倍率，基础1.0
@export_range(0.0, 5.0, 0.05, "or_greater") var fire_rate_multiplier: float = 1.0
